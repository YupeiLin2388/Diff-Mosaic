...
class Trainer(object):
    def __init__(self, args):
        ...
        trainset        = TrainSetLoader(dataset_dir,img_id=train_img_ids,base_size=args.base_size,crop_size=args.crop_size,transform=input_transform1,suffix=args.suffix)
    ...
    def testing (self, epoch):
        ...
        save_all(mean_IOU,self.save_dir, self.save_prefix,
